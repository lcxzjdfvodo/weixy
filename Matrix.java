...
public class Matrix {
	...
	public String[] generateMatrixArrayOfStr(String matrix){//从字符串中提取矩阵并将其生产一个字符串数组的类型
		String[] matrixArrayOfStr = matrix.trim().split("\\s+");
		return matrixArrayOfStr;
	}

	public int[] matrixArrayIntConvertFromMatrixArrayStr(String[] matrixArrayOfStr) {//把字符串矩阵转换为int类型矩阵
	...
	public int getMatrixLength(String[] matrix) {// 获取矩阵的长度
